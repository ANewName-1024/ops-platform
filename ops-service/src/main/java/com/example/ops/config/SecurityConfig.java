    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // 运维任务 (开发测试期间公开)
                .requestMatchers("/ops/tasks/**", "/ops/scripts/execute").permitAll()
                // 自愈策略 (开发测试期间公开)
                .requestMatchers("/ops/heal/**").permitAll()
                // 灰度发布 (开发测试期间公开)
                ...
                // AI (开发测试期间公开)
                .requestMatchers("/ops/ai/**").permitAll()
                // Dashboard (开发测试期间公开)
                .requestMatchers("/ops/dashboard/**").permitAll()
                // 监控数据 (需要 ops:view 权限)
